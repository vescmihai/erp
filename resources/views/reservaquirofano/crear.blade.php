...
<div class="container-xl">
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading">Crear Reserva de Quirofano</h3>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        {!! Form::open(array('route' => 'reservaquirofano.store','method'=>'POST')) !!}
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('cantidadHoras', null, array('class' => 'form-control')) !!}
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <label for="tipoIntervencion">Tipo de Intervencion</label>
                                    {!! Form::text('tipoIntervencion', null, array('class' => 'form-control')) !!}
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <label for="procedimiento">Procedimiento</label>
                                    {!! Form::text('procedimiento', null, array('class' => 'form-control')) !!}
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
