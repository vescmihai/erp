            ...
            <div class="card">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col">
                            ...
                            <div class="card-options">
                                <span class="text-muted">#{{ $pacientes->id }} &bull; {{ $pacientes->created_at }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-3">
                            <h6 class="text-uppercase text-muted ls-1 mb-1">Tutor</h6>
                            <h5 class="h3 mb-0">{{ $pacientes->tutor }}</h5>
                        </div>
                    </br>
                        <div class="col-md-3">
                            <h6 class="text-uppercase text-muted ls-1 mb-1">nro de Tutor</h6>
                            <h5 class="h3 mb-0">{{ $pacientes->nroTutor }}</h5>
                        </div>
                </div>
            </div>
        </div>
